package com.yeaile.appservice.generator.config;
...
public class CustomMySqlTypeConvert implements ITypeConvert {
    ...
    public IColumnType processTypeConvert(
        com.baomidou.mybatisplus.generator.config.GlobalConfig globalConfig,
    ...
    @Override
    public IColumnType processTypeConvert(
        com.baomidou.mybatisplus.generator.config.GlobalConfig globalConfig, String fieldType) {
        return null;
    }
}
